          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 border border-[#E6E6E6] rounded-[2px] focus:outline-none focus:border-[#F4008A]"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-2 border border-[#E6E6E6] rounded-[2px] focus:outline-none focus:border-[#F4008A] resize-none"
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-3 bg-[#F4008A] text-white rounded-[2px] font-medium hover:bg-[#D4007A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
