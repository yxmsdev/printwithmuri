...
export default function MerchPage() {
  ...
  const merchImages = [
    '/images/merch/1-elementor-io-optimized.webp',
    '/images/merch/2-elementor-io-optimized.webp',
    '/images/merch/3-elementor-io-optimized.webp',
    '/images/merch/4-elementor-io-optimized.webp',
    '/images/merch/5-elementor-io-optimized.webp',
    '/images/merch/6-elementor-io-optimized.webp',
    '/images/merch/7-elementor-io-optimized.webp',
    '/images/merch/8-elementor-io-optimized.webp',
    '/images/merch/9-elementor-io-optimized.webp',
  ];
    ...
    try {
      const response = await fetch('/api/newsletter/subscribe', {
        ...
        body: JSON.stringify({
          ...
          name: formData.name,
          source: 'merch_coming_soon',
        }),
      });

      if (response.ok) {
        setToastMessage("Thanks! We'll notify you when merch launches.");
      ...
      <div className="flex flex-col items-center px-4 pb-[60px] mt-[30px]">
        <div className="text-center mb-6">
          ...
          <h2 className="text-[24px] sm:text-[30px] font-bold text-black mb-3 leading-tight">
            Produce High Quality<br />Custom Merchandise
          </h2>
          <p className="text-[14px] text-[#6B6B6B] leading-[22px] max-w-[380px] mx-auto">
            Upload your designs and create high-quality custom items with ease.
          </p>
        </div>
